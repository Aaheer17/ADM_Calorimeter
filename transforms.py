...
class StandardizeFromFile(object):
    ...
    def __call__(self, shower, energy, rev=False):
        ...
        #print("standard: ",transformed.shape, energy.shape)
        return transformed, energy
    ...
    def __call__(self, shower, energy, rev=False):
            if rev:
                ...
                transformed = torch.log(energy + self.alpha)
                    ...
                    #print("Inside LogEnergy: ",shower.shape, transformed.shape)
...
class ScaleTotalEnergy(object):
    ...
    def __call__(self, shower, energy, rev=False):
        if rev:
            ...
            #print("inside Scale Total Energy: ",shower.shape, energy.shape)
        return shower, energy
...
class ScaleEnergy(object):
    ...
    def __call__(self, shower, energy, rev=False):
        ...
        #if shower is not None and transformed is not None:
            #print("Inside ScaleEnergy: ",shower.shape, transformed.shape)
        return shower, transformed
...
class ExclusiveLogitTransform(object):
    ...
    def __call__(self, shower, energy, rev=False):
        ...
        if self.exclusions is not None:
            ...
            #print("inside exclusive, transformed and energy: ",transformed.shape, energy.shape)
        return transformed, energy
...
class Reshape(object):
    ...
    def __call__(self, shower, energy, rev=False):
        if rev:
            ...
            #print("after reshaping: shower and energy: ",shower.shape, energy.shape)
        return shower, energy
...
class NormalizeByElayer(object):
    ...
    def __call__(self, shower, energy, rev=False):
        if rev:
            ...
            #print("inside Normalizeby Elayer Transform and energy: ",transformed.shape, energy.shape)
        return transformed, energy
